                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="form-group">
                                <input value="${notice.title}" type="text" class="form-control" name="title" placeholder="제목">
                            </div>
                            <div class="form-group">
                                <textarea id="content" name="content" placeholder="내용">${notice.content}</textarea>
                            </div>
                        </div>
