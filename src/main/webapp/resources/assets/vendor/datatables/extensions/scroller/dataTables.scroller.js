...
$.extend( Scroller.prototype, {
	...
	*/
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual diary.domain
	...
	/**
	 * Convert from one diary.domain to another. The physical diary.domain is the actual
	 ...
	 * only to that maximum value and virtual / physical diary.domain transforms will
